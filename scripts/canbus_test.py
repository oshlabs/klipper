...
# CMD_QUERY_UNASSIGNED = 0x00 # not used
CMD_QUERY_UNASSIGNED_EXTENDED = 0x03
...
def query_unassigned(canbus_iface):
    ...
    msg = can.Message(arbitration_id=CANBUS_ID_ADMIN,
                      data=[CMD_QUERY_UNASSIGNED_EXTENDED], is_extended_id=False) # the request is regular-, the response is extended id
    bus.send(msg)
    # Read responses
    found_ids = {}
